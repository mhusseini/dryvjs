...
const demoRuleSet: DryvValidationRuleSet<PersonalData> = {
    validators: {
        ...
        "vorname": [{
            ...
            validate: function ($m) {
                return /[^\u0020-\u00ff]/.test($m.vorname) ? "Bitte nutzen Sie nur die Zeichen aus dem westeurop\u0026#228;ischen Zeichensatz." : null
            }
        }, {
            validate: function ($m) {
        ...
        "nachname": [{
            ...
            validate: function ($m) {
                return /[^\u0020-\u00ff]/.test($m.nachname) ? "Bitte nutzen Sie nur die Zeichen aus dem westeurop\u0026#228;ischen Zeichensatz." : null
            }
        }, {
            validate: function ($m) {
        ...
        "geburtsdatum": [{
            ...
            validate: function ($m) {
                return ((!$m.geburtsdatum) || /^\d{4}-(02-(0[1-9]|[12][0-9])|(0[469]|11)-(0[1-9]|[12][0-9]|30)|(0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))$/.test($m.geburtsdatum.toString())) ? null : {
                    status: "error",
            ...
            validate: function ($m) {
                return ((!$m.geburtsdatum) || /\d{4}-\d{2}-\d{2}/.test($m.geburtsdatum.toString())) ? null : {
                    status: "error",
        ...
        "emailAdresse": [{
            ...
            validate: function ($m) {
                return /[^\u0020-\u00ff]/.test($m.emailAdresse) ? "Bitte nutzen Sie nur die Zeichen aus dem westeurop\u0026#228;ischen Zeichensatz." : null
            }
        }, {
            validate: function ($m) {
