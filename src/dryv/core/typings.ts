...
export interface DryvValidationSession<TModel extends object> {
    ...
    validateObject(objOrProxy: DryvValidatable<TModel> | DryvProxy<TModel>): Promise<DryvValidationResult<TModel> | null>;

    validateField<TValue>(field: DryvValidatable<TModel, TValue>, model?: TModel): Promise<DryvValidationResult<TModel> | null>;
}
